...
const DessertSelectionMenu3: React.FC = () => {
  ...
  const continuar = async () => {
    ...
    console.log('DessertSelectionMenu3 continuar - Guardando:', { event_id: eventId, paso: 'postre-menu3', datos: { postre } });
    ...
    if (error) {
      console.error('DessertSelectionMenu3 continuar - Error:', error.message);
      setError(`No se pudo guardar: ${error.message}`);
      return;
    }

    navigate(`/catering/menu3/kids?token=${token}`);
  };
...
export default DessertSelectionMenu3;