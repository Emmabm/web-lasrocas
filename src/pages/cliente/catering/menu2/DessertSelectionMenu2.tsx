...
const DessertSelectionMenu2: React.FC = () => {
  ...
  const continuar = async () => {
    ...
    console.log('DessertSelectionMenu2 continuar - Guardando:', { event_id: eventId, paso: 'postre-menu2', datos: { postre } });
    ...
    if (error) {
      console.error('DessertSelectionMenu2 continuar - Error:', error.message);
      setError(`No se pudo guardar: ${error.message}`);
      return;
    }

    navigate(`/catering/menu2/kids?token=${token}`);
  };
...
export default DessertSelectionMenu2;