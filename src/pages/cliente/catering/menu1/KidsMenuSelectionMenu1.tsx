...
const KidsMenuSelectionMenu1: React.FC = () => {
  ...
  const continuar = async () => {
    ...
    const { error } = await supabase
      ...
      .upsert([
        {
          event_id: eventId,
          paso: 'menu-infantil-menu1',
          datos: { menu_infantil: menuInfantil },
        },
    ...
    navigate(`/catering/menu1/bebidas?token=${token}`);
  };
...
export default KidsMenuSelectionMenu1;